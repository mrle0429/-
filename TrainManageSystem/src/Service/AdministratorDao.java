...
public class AdministratorDao {
    ...
    public static int getTotalNumberOfScheduledUser(String scheduleId){
        int count = 0;
    ...
    public static List<Schedules> getSchedulesByPage(int currentPage, int recordsPerPage){
    ...
    public static List<User> getScheduledUserByPage(String scheduleId, int currentPage, int recordsPerPage){
    ...
    public static Schedules getScheduleByID(String scheduleId){
        Connection conn = null;
        PreparedStatement st = null;
        ResultSet rs = null;
    ...
    public static boolean updateSchedule(Schedules schedule){
        Connection conn = null;
        PreparedStatement st = null;
        ResultSet rs = null;
    ...
    public static boolean insertSchedule(Schedules schedule){
        Connection conn = null;
        PreparedStatement st = null;
        ResultSet rs = null;
    ...
    private static Schedules createScheduleByResSet(ResultSet rs) throws SQLException {
        ...
        return new Schedules(scheduleId, trainId, departureStation, arrivalStation, departureTime, arrivalTime, availableSeats);
    }
